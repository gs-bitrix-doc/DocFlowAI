...
> Who can execute the method: an authorized user in the application

The `entity.item.get` method returns a list of items from the application's data storage.
...
`type` | **Description** ||
|| **ENTITY**^*^
[`string`](../../data-types.md) | Identifier of the application's data storage. Use the value you specified when creating the storage.

You can obtain the identifier via the [entity.get](../entities/entity-get.md) method. ||
|| **SORT**
...
Keys `field_n` can be prefixed with:
...
See the article [List method specifics](../../../settings/how-to-call-rest-api/list-methods-pecularities.md) ||
|#
...
|| **PREVIEW_PICTURE**
[`string`](../../data-types.md) \| [`null`](../../data-types.md) | Preview picture URL ||
|| **PREVIEW_TEXT**
[`string`](../../data-types.md) \| [`null`](../../data-types.md) | Preview text ||
|| **DETAIL_PICTURE**
[`string`](../../data-types.md) \| [`null`](../../data-types.md) | Detail picture URL ||
|| **DETAIL_TEXT**
[`string`](../../data-types.md) \| [`null`](../../data-types.md) | Detail text ||
|| **CODE**
...
|| **PROPERTY_VALUES**
[`object`](../../data-types.md) | Object of property values in format `{"CODE": value}`. The field is present if the storage has properties.

You can obtain the list of property codes via the [entity.item.property.get](./properties/entity-item-property-get.md) method. ||
|#
...
|| `ERROR_ARGUMENT` | Argument 'ENTITY' is null or empty | Parameter `ENTITY` is not passed or empty after trimming ||
|| `ERROR_ARGUMENT` | Entity code is too long. Max length is N characters. | Value of `ENTITY` is too long ||
|| `ERROR_ARGUMENT` | Filter validator errors | Invalid values for parameter `FILTER` ||
